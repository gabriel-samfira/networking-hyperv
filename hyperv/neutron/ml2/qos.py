...
from hyperv.common.i18n import _LI


LOG = logging.getLogger(__name__)


class HNVQosNotificationDriver(qos_base.QosServiceNotificationDriverBase):
    ...
    def get_description(self):
        return "HNV notification driver"
    ...
    def create_policy(self, context, policy):
        # No need to update HNV on create
        pass
...
class HNVQosDriver(object):
    """Qos driver for HNV"""

    def __init__(self, driver):
        LOG.info(_LI("Starting HNVQosDriver"))
        super(HNVQosDriver, self).__init__()
        self._driver = driver
